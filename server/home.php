          ...
          <div class='alert alert-success'>
            ...
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title"> ব্যবহারকারীদের তালিকা</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-primary">
                        <tr><th>আইডি</th><th>নামের প্রথম অংশ</th><th>নামের শেষাংশ</th><th>ইমেইল</th><th>পাসওয়ার্ড</th><th>যোগাযোগ</th><th>ঠিকানা</th><th>শহর</th>
                    </tr></thead>
                    <tbody>
                      <?php 
           ...
           <div class="row">
            ...
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title"> বিভাগ তালিকা</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
